...
<div class="page-banner">
      ...
      <div class="page-banner__content container t-center c-white">
        ...
        <a href="<?php echo get_post_type_archive_link('program'); //echo site_url('/program'); ?>" class="btn btn--large btn--blue">Find Your Major</a>
      </div>
    </div>
    ...
    <div class="full-width-split group">
      <div class="full-width-split__one">
        <div class="full-width-split__inner">
          ...
          <p class="t-center no-margin"><a href="<?php echo get_post_type_archive_link('event'); //echo site_url('/event'); ?>" class="btn btn--blue">View All Events</a></p>
        </div>
      </div>
